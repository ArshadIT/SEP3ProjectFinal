...
public class BranchDAO implements IBranchDAO {
	...
	public void EditBranch(Branch branch) {
		String sql = "UPDATE \"DentalClinic\".branch SET branchname ='" + branch.getBranchName() + "', phonenumber='"
				+ branch.getPhoneNumber() + "', branchemail='" + branch.getBranchEmail() + "' WHERE branchid ="
				+ branch.getBranchId() + ";";
		dbconn.WriteData(sql);
